      ...
      if (connected && wallet) {
        ...
        try {
          const {
            ...
            `/api/login/getNonce?addressWallet=${walletAddress}`
          );
          const signedMessage = await wallet.signData(nonce);
          const {
            data: { accessToken },
          } = await axios.post("/api/login/verifySignature", {
    ...
    <div className="container max-w-md py-12">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Connect your Cardano wallet to access the AgriTraceChain platform.
          </CardDescription>
        </CardHeader>
